...
class FlorealDate {
	...
	function toString() {
		return "{$this->republican_day()}-{$this->republican_month()}-{$this->republican_year()}";
	}
	...
	function set_republican_date($republican_year, $republican_month, $republican_day) {
		$first_day_of_year = $this->first_day_of_year($republican_year);
	...
	function republican_day_title() {
		...
		return array($keys[$this->republican_day_of_year()], $values[$this->republican_day_of_year()]);
	}
	...
	public function first_day_of_year() {
		return self::_first_day_of_year($this->republican_year());
	}

	public function is_year_sextile() {
		return self::_is_year_sextile($this->republican_year());
	}
